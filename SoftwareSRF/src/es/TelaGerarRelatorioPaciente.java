 ...
 * @author jeansb
 */
public class TelaGerarRelatorioPaciente extends javax.swing.JInternalFrame {

    /**
     * Creates new form TelaGerarRelatorio
     */
    public TelaGerarRelatorioPaciente() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        columnBinding = jTableBinding.addColumnBinding(org.jdesktop.beansbinding.ELProperty.create("${numeroprontuario}"));
        columnBinding.setColumnName("Numeroprontuario");
    ...
    private java.util.List<es.Paciente> pacienteList;
